...
\author{Jim Pivarski$^1$, Rocky Bala Garg$^2$, Richa Sharma$^3$, Alexander Moreno$^4$}
\institute{Princeton~U.$^1$, Stanford~U.$^2$, U.~Puerto Rico, Mayaguez$^3$, U.~Antonio Nariño$^4$}
...
\Large
\vspace{0.5 cm}
To understand our students! And make better decisions about what events to plan, how, and when.
\end{frame}
...
\vspace{0.5 cm}
\begin{center}
\only<1>{\includegraphics[width=\linewidth]{PLOTS/indico-registrations-map.png}\vspace{0.5 cm}}\only<2>{\includegraphics[width=0.8\linewidth]{PLOTS/indico-registrations-by-country.pdf}}
...
\vspace{0.2 cm}
\begin{center}
\only<1>{\includegraphics[width=0.93\linewidth]{PLOTS/website-access-per-week.pdf}}\only<2>{\includegraphics[width=0.93\linewidth]{PLOTS/website-access-per-week-2.pdf}}\only<3>{\includegraphics[width=0.93\linewidth]{PLOTS/website-access-per-week-3.pdf}}
\end{center}
\end{frame}
...
\begin{columns}
\column{1.1\linewidth}
\only<1>{\includegraphics[width=\linewidth]{PLOTS/modules-accessed-per-week.pdf}}\only<2>{\includegraphics[width=\linewidth]{PLOTS/modules-accessed-per-week-2.pdf}}
\end{columns}
